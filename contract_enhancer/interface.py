...
with gr.Blocks(fill_width=True) as demo:
    with gr.Row():
        with gr.Column():
            ...
            gr.Markdown("W tym narzędziu Bielik pokaże swoją moc w poprawianiu treści umów. Dodaj do biblioteki umowy na których powinien się wzrować, a następnie wprowadź paragraf który chcesz poprawić.")
            ...
            upload_button = gr.UploadButton(label="Dodaj umowę do biblioteki", file_count="multiple", file_types=["pdf"])
